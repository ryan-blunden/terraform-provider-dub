...
// Generated from OpenAPI doc version 0.0.1 and generator version 2.941.0
...
func New(opts ...SDKOption) *Dub {
	sdk := &Dub{
		SDKVersion: "0.1.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:         "speakeasy-sdk/terraform 0.1.0 2.941.0 0.0.1 github.com/ryan-blunden/terraform-provider-dub/internal/sdk",
			SDKVersion:        "0.1.0",
			GenVersion:        "2.941.0",
